...
module.exports = function(model, opts) {
  ...
  function checkAccess(permission, paramName) {
    return function(req, res, next) {
      ...
      if (paramName) {
        ...
        controller.checkAccess(req, permission, checkResult);
      }
    }
  }
  ...
  // Node CRUD
  controller.define(
    'read', ['accessors', checkAccess('r', model.type)], 
  ...
  controller.define(
    'create', ['accessors', 'mutators', checkAccess('w')], 
    function(req, res) {
  ...
  controller.define(
    'update', ['accessors', 'mutators', checkAccess('w', '_id')], 
    function(req, res) {
  ...
  controller.define(
    'update-root', ['accessors', 'mutators', checkAccess('w', '_id')], 
    function(req, res) {
      if (req.params._id != null && req.body.id == null) {
        req.body.id = req.params._id;
      }
