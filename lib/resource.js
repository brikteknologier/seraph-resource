...
module.exports = function(model) {
  ...
  controller.middleware('mutators', function(req, res, next) {
    if (typeof req.body == "object" && Object.keys(req.body) == 0) // req.body == {}
      return next();
  ...
  controller.define('update-root', ['accessors', 'mutators'], function(req, res) {
    if (req.params._id != null && req.body.id == null) {
      req.body.id = req.params._id;
    }
      ...
      controller.define('create:' + field, 
        ...
        function(req, res) {
          if (req[model.type][field] != null) {
            res.json(409, 'Property already exists');
          } else {
